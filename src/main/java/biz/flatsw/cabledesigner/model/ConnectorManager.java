...
public interface ConnectorManager {
    ...
    Connector referenceConnector(Location referenceLocation, String name);

    Connector getConnector(String name);

    Connector createConnector(Location definitionLocation,
                              String name, String description,
                              ConnectorModelIdentification model);

    Collection<Connector> listConnectors();
